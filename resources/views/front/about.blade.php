<x-front.layout>
    ...
    <div class="container">
        <div class="container-left">
            <div class="text">
                ...
                <p>Bullying adalah masalah serius yang dapat berdampak negatif pada korban, <br>baik secara fisik maupun
                    ...
                    Oleh sebab itu kami mendirikan <br><span style="color: #2F59A7;">Lawan</span><span style="color:  darkorange">Bullying</span>
        ...
        <div class="container-right">
            <img class="container" src="{{ asset('assets/images/photos/lawanbullying.png') }}" width="800px" height="400px">
        </div>
    </div>
</x-front.layout>
