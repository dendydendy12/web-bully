...
<body class="font-[Poppins] pb-[72px]">
    <nav id="Navbar" class="max-w-[1130px] mx-auto flex justify-between items-center mt-[30px]">
        ...
        <div class="flex items-center gap-3">
            <a href="" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#0B2F9F]">Upgrade Pro</a>
            <a href="{{route('front.about')}}" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#0B2F9F]">About Us</a>
            <a href="" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#0B2F9F]">Lapor Bullying</a>
            <a href="" class="rounded-full p-[12px_22px] flex gap-[10px] font-bold transition-all duration-300 bg-[#FF6B18] text-white hover:shadow-[0_10px_20px_0_#0B2F9F]">
                ...
                <a href="{{ route('front.details', $article->slug) }}" class="card-news">
                    <div
                        ...
                        <div
                            ...
                            @if ($article->category)
                                <p
                                    class="badge-white absolute top-5 left-5 rounded-full p-[8px 18px] bg-white font-bold text-xs leading-[18px]">
    ...
    <section id="bullying" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
        <div class="flex justify-between items-center">
            <h2 class="font-bold text-[26px] leading-[39px]">
                Tentang<br />
                Bullying
        ...
        <div class="flex justify-between items-center h-fit">
            <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
                @if ($bullying_featured_articles)
                    <img src="{{ Storage::url($bullying_featured_articles->thumbnail) }}"
                        class="thumbnail absolute w-full h-full object-cover" alt="icon" />
                @else
                    ...
                    <img src="{{ asset('path/to/placeholder.jpg') }}"
                        class="thumbnail absolute w-full h-full object-cover" alt="placeholder icon" />
                @endif
                <div class="w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,0.9)] absolute z-10">
                </div>
